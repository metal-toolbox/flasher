...
func (mr *MockDeviceQueryorMockRecorder) FirmwareInstallSteps(ctx, component interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceQueryorMockRecorder) FirmwareInstallUploaded(ctx, component, uploadVerifyTaskID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDeviceQueryor) FirmwareTaskStatus(ctx context.Context, kind constants.FirmwareInstallStep, component, taskID, installVersion string) (string, string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDeviceQueryorMockRecorder) FirmwareTaskStatus(ctx, kind, component, taskID, installVersion interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeviceQueryorMockRecorder) FirmwareUpload(ctx, component, reader interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
